#!/usr/bin/env python3
"""Smoke-check VarMDyn workflow scripts without local data files.
...
run directory. It does not copy or publish trajectory-derived data, generated
figures, or private tables.
"""
...
def write_report(checks: list[Check], outdir: Path) -> Path:
    ...
    report = outdir / "workflow_smoke_checks.csv"
