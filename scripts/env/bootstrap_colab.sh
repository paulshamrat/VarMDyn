...
# Usage:
#   bash scripts/env/bootstrap_colab.sh
#   REPO=paulshamrat/VarMDyn REF=main bash scripts/env/bootstrap_colab.sh
...
python scripts/checks/compare_clustering_outputs.py --help >/dev/null
