...
INPUT_ROOT="${VARMDYN_RMSF_APO_INPUT_ROOT:-${VARMDYN_DATA_ROOT:-$ROOT/data}/rmsf/apo_root}"
OUT_DIR="${VARMDYN_RMSF_APO_OUT_DIR:-${VARMDYN_RUN_ROOT:-$ROOT/runs}/mdan/rmsf/apo}"
