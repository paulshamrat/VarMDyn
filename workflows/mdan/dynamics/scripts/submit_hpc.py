...
LOCAL_FETCH_ROOT = Path(os.environ.get("DYNAMICS_NLOBE_Y171_FETCH_ROOT", RUN_ROOT / "mdan/dynamics/hpc_fetch"))
...
REMOTE_STAGE = REMOTE_ROOT / "03_md/analysis_repro/results/replay/dynamics"
...
LOCAL_FILES_TO_STAGE = [
    (SCRIPT_DIR / "hpc.sbatch", REMOTE_SBATCH),
    (SCRIPT_DIR / "build_rmsf.py", REMOTE_SCRIPTS / "build_rmsf.py"),
    (SCRIPT_DIR / "build_displacement.py", REMOTE_SCRIPTS / "build_displacement.py"),
    (SCRIPT_DIR / "make_displacement_tsvs.py", REMOTE_SCRIPTS / "make_displacement_tsvs.py"),
]
