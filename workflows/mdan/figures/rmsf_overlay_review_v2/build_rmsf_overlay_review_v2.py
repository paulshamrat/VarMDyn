...
# This script only composes the already-rendered apo and holo RMSF overlay PNGs.
# The original plot generator for each source panel lives at:
#   251008_simulation/00_scripts/plot_rmsf_all_variants_replicas_range_mean.py

FIGURES_DIR = Path(__file__).resolve().parents[1]
ROOT = Path(__file__).resolve().parents[4]
OUT_DIR = Path(__file__).resolve().parent

APO = FIGURES_DIR / "source_panels/rmsf_variant_means_overlay_range.png"
HOLO = FIGURES_DIR / "source_panels/rmsf_variant_means_overlay_range_atpmg.png"
