...
RAW_DIR="$ROOT/manuscript/assets/main_candidates/rmsf_overlay_review_v2/source_inputs/holo_raw"
OUT_DIR="$ROOT/manuscript/modules/03_md/figs/holo_rmsf_replay_same_style"
