...
def main() -> None:
    ...
    make_panel(
        apo_render_dir,
        "apo",
        Path("manuscript/assets/main_candidates/260221_network_apo_pathway_tight.png"),
        Path("manuscript/assets/main_candidates/260221_network_apo_pathway_tight.jpg"),
        show_legend=True,
    )
    make_panel(
        holo_render_dir,
        "holo",
        Path("manuscript/assets/main_candidates/260221_network_holo_pathway_repro_tight.png"),
        Path("manuscript/assets/main_candidates/260221_network_holo_pathway_repro_tight.jpg"),
        show_legend=True,
    )
    make_combined_preview(
        apo_render_dir,
        holo_render_dir,
        Path("manuscript/assets/main_candidates/260223_network_compare_preview_2col_tight_v16.png"),
    )
    print("[OK] wrote tight apo+holo panels and manuscript preview")
