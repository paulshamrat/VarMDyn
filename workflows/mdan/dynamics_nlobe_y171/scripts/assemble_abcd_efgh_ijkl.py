...
Run from repository root:
    python workflows/mdan/dynamics_nlobe_y171/scripts/assemble_abcd_efgh_ijkl.py
"""
...
OUT_DIR = Path(os.environ.get(
    ...
    Path(os.environ.get("VARMDYN_RUN_ROOT", ROOT / "runs")) / "dynamics_nlobe_y171",
))
# ---------------------------------------------------------------------------
# Panel paths
# ---------------------------------------------------------------------------
...
def main() -> None:
    ...
    parts.append("</svg>")
    svg_out = OUT_DIR / "dynamics_nlobe_y171.svg"
    ...
    png_out = OUT_DIR / "dynamics_nlobe_y171.png"
