...
OUT_DIR = Path(os.environ.get(
    ...
    Path(os.environ.get("VARMDYN_RUN_ROOT", ROOT / "runs")) / "dynamics_nlobe_y171" / "panels_efgh",
))
...
def input_paths(state: str, variant: str) -> list[Path]:
    ...
    if state == "apo":
        roots = [
            ...
            ROOT / "manuscript/assets/main_candidates/rmsf_overlay_review_v2/source_inputs/apo_root/03_mdsim",
        ]
    else:
        roots = [
            LEGACY_BASE / "05_cdkl5atpmg",
            ROOT / "manuscript/assets/main_candidates/rmsf_overlay_review_v2/source_inputs/holo_raw",
        ]
...
def write_source_bundle(
    ...
    """Write lightweight RMSF inputs and mean tables for manuscript audit."""
