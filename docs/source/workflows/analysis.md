...
Network figures are not generated by the RMSD/RMSF section above. After the
network Slurm jobs are complete and fetched, build the network tables first and
then the figures:
